...
public class CourseResourceIntTest {
    ...
    private static final Integer DEFAULT_CTIME = 1;
    private static final Integer UPDATED_CTIME = 2;
    ...
    public void createCourse() throws Exception {
        ...
        assertThat(testCourse.getCname()).isEqualTo(DEFAULT_CNAME);
        assertThat(testCourse.getCtime()).isEqualTo(DEFAULT_CTIME);
    ...
    @Test
    @Transactional
    public void checkCtimeIsRequired() throws Exception {
        int databaseSizeBeforeTest = courseRepository.findAll().size();
        // set the field null
        course.setCtime(null);
    ...
    public void getAllCourses() throws Exception {
        ...
        restCourseMockMvc.perform(get("/api/courses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ctime").value(hasItem(DEFAULT_CTIME)))
    ...
    public void getCourse() throws Exception {
        ...
        restCourseMockMvc.perform(get("/api/courses/{id}", course.getId()))
            ...
            .andExpect(jsonPath("$.ctime").value(DEFAULT_CTIME))
    ...
    public void updateCourse() throws Exception {
        ...
        Course testCourse = courseList.get(courseList.size() - 1);
        assertThat(testCourse.getCname()).isEqualTo(UPDATED_CNAME);
        assertThat(testCourse.getCtime()).isEqualTo(UPDATED_CTIME);
