...
public class SqlUtil {
    ...
    public static String ORACLE_DIALECT = "oracle";

    public static String DB2_DIALECT = "db2";

    public static String MYSQL_DIALECT = "mysql";

    public static String POSTGRESQL_DIALECT = "postgresql";

    public static String H2_DIALECT = "h2";
    ...
    public static String makeScrollSql(String sql, String dialect, int start, int len) {
